...
/*	if(!$res)
	...
	if($check>0){
     ...
     header("location:cust_rep.php?from=$from&to=$to");
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card" >
                        <div class="card-body"><strong>Customer Report</strong></div>
                        <h4 class="box-link"><a href="reports.php"><button type="button" style="margin-left:30px" class="btn btn-primary mr-2">Back</button></a></h4>
                        <form method="post">
						...
						<a href="order_rep.php?all=1"><button style="margin-left:150px;margin-top:-125px;" id="payment-button" name="all" type="submit" class="btn btn-primary mr-2">Get All
							   </button></a>
                     </div>
                  </div>
               </div>
