...
if(isset($_POST['submit'])){
	...
	$sr="select tbl_order_master.*,tbl_order_child.*,tbl_item.*,tbl_cust.*,tbl_staff.*,tbl_stall.*,tbl_pay.* from tbl_order_master,tbl_order_child,tbl_item,tbl_cust,tbl_staff,tbl_stall,tbl_pay where tbl_order_master.Morder_id=tbl_order_child.Morder_id AND tbl_order_master.Cust_id=tbl_cust.Cust_id AND tbl_order_master.Staff_id=tbl_staff.Staff_id AND tbl_stall.Stall_id=tbl_item.Stall_id AND tbl_order_child.Item_id=tbl_item.Item_id AND tbl_order_master.Morder_id=tbl_pay.Morder_id AND tbl_order_master.order_date BETWEEN DATE('$from') AND DATE('$to')";
...
/*	if(!$res)
	...
	if($check>0){
     ...
     header("location:pay_rep.php?from=$from&to=$to");
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card" >
                        <div class="card-body"><strong>Payment Report</strong></div>
						...
						<a href="pay_rep.php?all=1"><button style="margin-left:150px;margin-top:-125px;" id="payment-button" name="all" type="submit" class="btn btn-primary mr-2">Get All
							   </button></a>
                     </div>
                  </div>
               </div>
