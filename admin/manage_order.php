...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		...
		echo "update tbl_order_master set Order_status='$Order_status' where Morder_id='$Morder_id'";
			mysqli_query($con,"update tbl_order_master set Order_status='$Order_status' where Morder_id='$Morder_id'");
			if($Order_status==$s1)
			{
