...
if(isset($_GET['Staff_id']) && $_GET['Staff_id']!=''){
	...
	$res=mysqli_query($con,"select tbl_staff.*,tbl_login.* from tbl_staff,tbl_login where tbl_login.Username='$Username' and tbl_staff.Username='$Username'");
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
									...
									<input type="text" id="Staff_city" name="Staff_city" placeholder="Enter City" class="form-control" required value="<?php echo $Staff_city?>">
                                     <p> <?php if(isset($errors['c']))echo $errors['p']; ?></p>
								</div>
								 <div class="form-group">
