...
$sql="select tbl_allocation.*, tbl_staff.Staff_name, tbl_stall.Stall_name from tbl_allocation, tbl_staff, tbl_stall where tbl_allocation.Staff_id=tbl_staff.Staff_id and tbl_allocation.Stall_id=tbl_stall.Stall_id ";
