                        ...
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
									<label for="staff" title="Enter Valid name" pattern="[A-Za-z]{1,32}{ }" class=" form-control-label">Name</label>
                                ...
                                <div class="form-group">
									...
									<input type="email" title="Enter Valid Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" id="Username" name="Username" placeholder="Enter Username" class="form-control" required value="<?php echo $Username?>">
								</div>
                                <div class="form-group">
									<label for="staff" class=" form-control-label">Password</label>
									<input type="text" id="Password" name="Password" placeholder="Enter Password" class="form-control" required value="<?php echo $Username?>">
								</div>
							   <div class="form-group">
									<label for="staff" class=" form-control-label">House name</label>
									<input type="text" title="Enter Valid name" pattern="[A-Za-z]{1,32}{ }" id="Staff_hname" name="Staff_hname" placeholder="House name" class="form-control" required value="<?php echo $Staff_hname?>">
								</div>

                                <div class="form-group">
									<label for="staff" title="Enter Valid name" pattern="[A-Za-z]{1,32}{ }" class=" form-control-label">Street name</label>
								 ...
								 <div class="form-group">
									<label for="staff" title="Enter Valid name" pattern="[A-Za-z]{1,32}" class=" form-control-label">City</label>
								 ...
								 <div class="form-group">
									...
									<input type="text" id="Staff_pin" maxlength="6" name="Staff_pin" placeholder="Enter Pincode" class="form-control" required value="<?php echo $Staff_pin?>">
								</div>								
                                <div class="form-group">
									<label for="staff" class=" form-control-label">Mobile Number</label>
									<input type="text" title="Enter Valid phone number" pattern="[6-9]{1}[0-9]{9}" id="Staff_phone" maxlength="10" name="Staff_phone" placeholder="Enter Mobile Number" class="form-control" required value="<?php echo $Staff_phone?>">
								</div>
                                <div class="form-group">
									<label for="staff" class=" form-control-label">Date of Birth</label>
									<input type="date" id="Staff_dob"  min="1955-01-01" max="2001-12-31" name="Staff_dob" placeholder="DOB" class="form-control" required value="<?php echo $Staff_dob?>">
								</div>								
