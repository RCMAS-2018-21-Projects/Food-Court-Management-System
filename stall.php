...
<?php
include ("header.php");
$Stall_id=mysqli_real_escape_string($con,$_GET['id']);
$q="select * from tbl_stall where Stall_id='$Stall_id'";
            ...
            <div class="container">
                ...
                <div class="row flex-row-reverse">
                    ...
                    <div class="col-lg-9">
                         ...
                         <h2 style="color: #e02c2b"><?php echo $r['Stall_name'] ?></h2>
                        ...
                        <div class="grid-list-product-wrapper">
                            <div class="product-grid product-view pb-20">
                                <div class="row">
                                    <?php
                                                     $query="select * from tbl_item where Stall_id='$Stall_id'";
