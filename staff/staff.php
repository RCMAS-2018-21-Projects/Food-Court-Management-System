                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
						...
						<tr>
							...
							<td>
								<a href="manage_staff.php?Staff_id=<?php echo $row['Staff_id']?>"><label class="badge badge-success">Edit</label></a>&nbsp;
							
								&nbsp;
								<a href="?Staff_id=<?php echo $row['Staff_id']?>&type=delete"><label class="badge badge-danger delete_red">Delete</label></a>
							</td>
